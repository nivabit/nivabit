...
export default function Navbar() {
  return (
    <div className='w-full bg-primary text-accent py-8'>
      <Container>
        <div className='flex fle-col md:flex-row  items-start space-x-20'>
          <div className='self-center space-y-6  basis-[45%] h-full'>
            <Image src={LightLogo} alt='logo' />
            <p className='  w-4/5 text-gray-50 opacity-80  leading-relaxed'>
            ...
            <div className='flex items-center justify-start space-x-4'>
              <Link href={"/"} className='p-3 bg-gray-50 rounded-md'>
                ...
                >
                  <g clip-path='url(#clip0_419_3572)'>
              ...
              <Link href={"/"} className='p-3 bg-gray-50 rounded-md'>
                <svg
                  ...
                  xmlns='http://www.w3.org/2000/svg'
                >
                  <g clip-path='url(#clip0_419_3574)'>
              ...
              <Link href={"/"} className='p-3 bg-gray-50 rounded-md'>
                <svg
                  ...
                  xmlns='http://www.w3.org/2000/svg'
                >
                  <g clip-path='url(#clip0_419_3576)'>
