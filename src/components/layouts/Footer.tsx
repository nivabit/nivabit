      ...
      <Container>
        <div className='flex flex-col space-y-12 md:flex-row  items-start md:pace-x-10'>
          <div className='self-center space-y-6  md:basis-[55%] h-full flex-1'>
            ...
            <p className=' w-full  md:w-3/5 text-gray-50 opacity-80  leading-relaxed'>Ready to take the next step? Have questions about our services? We&apos;re here to help. Let&apos;s start building something incredible together.</p>
            <div className='flex items-center justify-start space-x-4'>
              <Link href={"/"} className='p-3 bg-gray-50 rounded-[8px]'>
                <svg strokeLinecap='round' strokeLinejoin='round' className='size-6 fill-secondary' xmlns='http://www.w3.org/2000/svg'>
                  ...
                  <defs>
                    <clipPath id='clip0_419_3572'>
                      <rect className='size-6 fill-gray-50' transform='translate(0 0.645508)' />
                    </clipPath>
                  </defs>
                </svg>
              </Link>
              ...
              <Link href={"/"} className='p-3 bg-gray-50 rounded-[8px]'>
                <svg strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' className='size-6 fill-secondary rounded-sm' xmlns='http://www.w3.org/2000/svg'>
          ...
          <div className='md:space-y-6 space-y-3 md:basis-[25%] md:self-center '>
            <h3 className=' capitalize md:font-light font-semibold font-grotesk'>Quick Links</h3>

            <ul className='flex flex-col items-start md:space-y-6 space-y-3 justify-start '>
              <li>
                <Link href='#services' legacyBehavior passHref className='capitalize cursor-pointer text-gray-50/85 '>
                  Service
                </Link>
              </li>
              <li>
                <Link href='#portfolio' legacyBehavior passHref className='capitalize cursor-pointer text-gray-50/85 '>
                  Portfolio
                </Link>
              </li>
              <li>
                <Link href='#about-us' legacyBehavior passHref className='capitalize cursor-pointer text-gray-50/85 '>
                  About Us
                </Link>
              </li>
              <li>
                <Link href='#contact-us' legacyBehavior passHref className='capitalize cursor-pointer text-gray-50/85 '>
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div className='md:basis-[25%] self-center h-full'>
            <h3 className='capitalize md:font-light font-semibold font-grotesk'>Contact us</h3>
            <p className='md:py-6 py-2 text-gray-50 opacity-80  leading-relaxed'>Ready to take the next step? Have questions about our services</p>
            <div className='flex flex-col items-start space-y-3'>
              <Link href='lorem' className='flex items-center space-x-4'>
                ...
                <span className='opacity-80 '>contact@nivabit.com</span>
              </Link>
        ...
        <div className='flex flex-col-reverse gap-6 lg:flex-row justify-between'>
          <p className=' capitalize font-light'>&copy; Nivabit {new Date().getFullYear()} all right reserved</p>
