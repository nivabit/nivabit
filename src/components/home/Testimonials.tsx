          ...
          <CarouselContent className='flex items-center gap-x-[20px]'>
            {CustomerQuotes.map(
              ({ name, position, description, company, image }, index) => (
                <CarouselItem
                  key={index}
                  className=' basis-full  md:basis-[50%] lg:basis-[24%]'
                >
                  <Card
                    className='bg-accent border shadow-sm rounded-[14px] transition-all duration-500 relative p-[10px] lg:p-[15px]'
                    key={index}
                  >
                    <CardHeader>
                      <CardTitle className=' mb-4'>
                        <div className='relative'>
                          <div className='bg-gray-50 h-16 w-16 p-1 rounded-[8px] '>
                            <Image
                        ...
                        <div className='absolute -right-1 top-[2.5rem] lg:top-[3.5rem]'>
                          <svg
                            className='size-[7rem]'
