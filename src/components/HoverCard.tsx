      ...
      >
        <Card>
          <CardHeader className='py-4'>
            ...
            <CardDescription className='text-orange-500 font-medium group-hover:text-blue-900 group-hover:pt-1 '>
              {title}
            </CardDescription>
          </CardHeader>
          <CardContent className=''>
            ...
            <p className='hidden group-hover:flex h-auto text-xs '>{content}</p>
          </CardContent>
        </Card>
      </div>
    </>
